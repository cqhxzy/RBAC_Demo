          ...
          <div class="table-responsive">
            ...
            <table class="table  table-bordered">
              ...
              <tbody id="roleData">
					<tr>
					  <td>1</td>
					  <td><input type="checkbox" name="roleid" value="1"></td>
					  <td>zhangsan</td>
					  <td>
						  <button type="button" onclick="goAssignPage('+role.id+')" class="btn btn-success btn-xs"><i class=" glyphicon glyphicon-check"></i></button>
						  <button type="button" onclick="goUpdatePage('+role.id+')" class="btn btn-primary btn-xs"><i class=" glyphicon glyphicon-pencil"></i></button>
						  <button type="button" onclick="" class="btn btn-danger btn-xs"><i class=" glyphicon glyphicon-remove"></i></button>
					  </td>
					</tr><tr>
					  <td>1</td>
					  <td><input type="checkbox" name="roleid" value="1"></td>
